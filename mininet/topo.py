...
class LabTopology(Topo):
    ...
    def build(self):
        ...
        self.addLink(switch, homePC)
        self.addLink(switch, tablet)
        self.addLink(switch, phone)
        self.addLink(router, switch, params1={"ip": "192.168.0.1/24"})
...
def run():
    ...
    net = Mininet(topo=LabTopology(), link=TCLink, host=NoIpv6OffloadHost,
